...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen bg-cyan-50 flex flex-col md:flex-row items-center justify-center px-6 md:px-12 py-20">
      {/* Left Text Content */}
      <div className="md:w-1/2 text-center md:text-left space-y-6 z-10">
        <span className="inline-block bg-purple-100 text-purple-700 px-4 py-1 rounded-full font-medium text-sm">
          Recipe of the Day
        </span>
        <h1 className="text-4xl md:text-5xl font-extrabold text-cyan-900 leading-tight">
          Spinach and Feta Egg Muffins
        </h1>
        <div className="text-sm text-gray-600">1 hour and 30 mins</div>
        <p className="text-gray-700 max-w-md">
          There are many variations of passages, but the majority have suffered alteration in some form, by injected humour, or randomized words which don’t look even...
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
          ...
          <a
            href="#categories"
            className="bg-white border-2 border-purple-600 text-purple-600 hover:bg-purple-50 font-semibold py-3 px-6 rounded-full transition"
          >
            Explore Recipes
          </a>
        </div>
